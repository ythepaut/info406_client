package fr.groupe4.clientprojet.utils.loaddialog;
...
public class LoadCanvas extends Canvas {
    ...
    public void paint(Graphics g) {
        ...
        try {
            g2.drawImage(ImageIO.read(new File(Location.getPath() + "/fr/groupe4/clientprojet/data/img/loading.png")), x, y, width, width, this);
        } catch (IOException e) {
            e.printStackTrace();
        }
        angle += 2;
